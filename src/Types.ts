export enum CLASSES {
    ...
    FLEXLAYOUT__FLOATING_WINDOW = "flexlayout__floating_window",
    FLEXLAYOUT__FLOATING_WINDOW_HEADER = "flexlayout__floating_window_header",
    FLEXLAYOUT__FLOATING_WINDOW_TITLE = "flexlayout__floating_window_title",
    FLEXLAYOUT__FLOATING_WINDOW_BUTTONS = "flexlayout__floating_window_buttons",
    FLEXLAYOUT__FLOATING_WINDOW_BUTTON_DOCK = "flexlayout__floating_window_button_dock",
    FLEXLAYOUT__FLOATING_WINDOW_BUTTON_CLOSE = "flexlayout__floating_window_button_close",
    FLEXLAYOUT__FLOATING_WINDOW_CONTENT = "flexlayout__floating_window_content",
    FLEXLAYOUT__FLOATING_WINDOW_RESIZE_HANDLE = "flexlayout__floating_window_resize_handle",
